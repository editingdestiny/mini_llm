...
class SFTDataset(Dataset):
    ...
    def __getitem__(self, idx):
        ...
        # Mark padded positions so cross-entropy ignores them (avoids training
        # the model to predict PAD tokens, which would waste capacity and
        # artificially inflate loss on padded sequences).
        pad_token_id = self.tokenizer.pad_id
        target_ids = target_ids.masked_fill(target_ids == pad_token_id, -100)
